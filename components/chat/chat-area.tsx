  ...
  (
    ...
    return (
      <div
        ...
        className={cn(
          'bg-white/70 dark:bg-slate-900/70 backdrop-blur-2xl border-l border-white/30 dark:border-slate-700/30 shadow-[-4px_0_32px_rgba(0,0,0,0.04)] dark:shadow-[-4px_0_32px_rgba(0,0,0,0.3)] flex flex-col shrink-0 z-20 relative overflow-visible',
          className,
        )}
      >
        {/* Drag handle */}
